  ...
  export default {
    ...
    methods: {
      ...
      login () {
        ...
        _this.$axios.post(process.env.VUE_APP_SERVER + '/business/web/member/login', _this.member).then((response)=>{
          let resp = response.data;
          if (resp.success) {
      ...
      sendSmsForRegister() {
        ...
        _this.$axios.get(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist/' + _this.memberRegister.mobile).then((res)=>{
      ...
      sendSmsForForget() {
        ...
        _this.$axios.get(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist/' + _this.memberForget.mobile).then((res)=>{
          let response = res.data;
          if (response.success) {
      ...
      resetPassword() {
        ...
        // 调服务端密码重置接口
        _this.$axios.post(process.env.VUE_APP_SERVER + '/business/web/member/reset-password', _this.memberForget).then((res)=>{
          let response = res.data;
          if (response.success) {
